        ...
        <div class="menu-items">
            <ul class="nav-links">
                <li><a href="javascript:void(0)" id="add-notes">
                        ...
                        <span class="link-name">Add Weekly Report</span>
                    </a></li>
                            ...
                            <div class="notes-content">
                                <form action="javascript:void(0);" id="addweeklyreport">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                    <div class="links-and-photos">
                                        <!-- Input fields for links and photos -->
                                        <!-- <label for="links">Link:</label>
                                        <input type="text" id="links" name="links" class="form-control" placeholder="Enter a link"> -->

                                        <div class="form-group">
                                            <span>Link</span>
                                            <input class="form-field" type="text" placeholder="domain.tld" required>
                                        </div>

                                        <div class="note">
                                            <span>Note: Please provide public link of the Drive folder.</span>
                                        </div>

                                        <!-- <label for="photos">Photos:</label>
                                        <input type="file" id="photos" name="photos[]" accept="image/*" class="form-control" multiple> -->
                                    </div>
                                </div>
                                    </div>
                                </form>
